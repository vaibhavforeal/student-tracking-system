...
import {
  GraduationCap, BarChart3, ClipboardList, User, BookOpen,
  Mail, Phone, Calendar, MapPin, Lightbulb, MessageSquare
} from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'var(--space-4)', marginBottom: 'var(--space-5)' }}>
        <div className="card" style={{ padding: 'var(--space-4) var(--space-4)', cursor: 'pointer', transition: 'all var(--transition-fast)' }} onClick={() => navigate('/student/marks')}>
        ...
        <div className="card" style={{ padding: 'var(--space-4) var(--space-4)', cursor: 'pointer', transition: 'all var(--transition-fast)' }} onClick={() => navigate('/student/attendance')}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', marginBottom: 'var(--space-3)' }}>
        ...
        <div className="card" style={{ padding: 'var(--space-4) var(--space-4)', cursor: 'pointer', transition: 'all var(--transition-fast)' }} onClick={() => navigate('/student/profile')}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', marginBottom: 'var(--space-3)' }}>
            <User size={28} className="idata" style={{ color: 'var(--color-indigo-500)' }} />
        ...
        <div className="card" style={{ padding: 'var(--space-4) var(--space-4)', cursor: 'pointer', transition: 'all var(--transition-fast)' }} onClick={() => navigate('/student/skill-courses')}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', marginBottom: 'var(--space-3)' }}>
            <Lightbulb size={28} className="idata" style={{ color: 'var(--color-warning)' }} />
        ...
        <div className="card" style={{ padding: 'var(--space-4) var(--space-4)', cursor: 'pointer', transition: 'all var(--transition-fast)' }} onClick={() => navigate('/student/feedback')}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', marginBottom: 'var(--space-3)' }}>
            <MessageSquare size={28} className="idata" style={{ color: 'var(--color-purple-500)' }} />
      ...
      {profile && (
        <div className="card">
          <div style={{ padding: 'var(--space-3) var(--space-4)', borderBottom: '1px solid var(--color-gray-100)' }}>
            <h3 style={{ fontSize: 'var(--font-lg)', fontWeight: 600 }}>Profile Summary</h3>
          </div>
          <div style={{ padding: 'var(--space-4)' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 'var(--space-4)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                <User size={18} className="idata" style={{ color: 'var(--color-gray-400)', flexShrink: 0 }} />
                <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                <Mail size={18} className="idata" style={{ color: 'var(--color-gray-400)', flexShrink: 0 }} />
                <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                <Phone size={18} className="idata" style={{ color: 'var(--color-gray-400)', flexShrink: 0 }} />
                <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                <Calendar size={18} className="idata" style={{ color: 'var(--color-gray-400)', flexShrink: 0 }} />
                <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                <GraduationCap size={18} className="idata" style={{ color: 'var(--color-gray-400)', flexShrink: 0 }} />
                <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                <MapPin size={18} className="idata" style={{ color: 'var(--color-gray-400)', flexShrink: 0 }} />
                <div>
