...
const statusStyles = {
  present: { bg: 'rgba(34, 197, 94, 0.08)', color: '#16a34a', label: 'Present', Icon: HiOutlineCheck },
  absent: { bg: 'rgba(239, 68, 68, 0.08)', color: '#dc2626', label: 'Absent', Icon: HiOutlineX },
  late: { bg: 'rgba(245, 158, 11, 0.08)', color: '#d97706', label: 'Late', Icon: HiOutlineClock },
};
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 'var(--space-4)', marginBottom: 'var(--space-6)' }}>
        ...
        <div className="card" style={{
          ...
          background: overallPct >= 75 ? 'rgba(34, 197, 94, 0.08)' : overallPct >= 50 ? 'rgba(245, 158, 11, 0.08)' : 'rgba(239, 68, 68, 0.08)',
        }}>
          <div style={{
              ...
              <div key={cs.courseId} style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)' }}>
                ...
                <div style={{ flex: 1, height: 10, borderRadius: 'var(--radius-full)', background: 'var(--color-gray-100)', overflow: 'hidden' }}>
                  <div style={{
                    ...
                    background: cs.percentage >= 75 ? 'var(--color-success)' : cs.percentage >= 50 ? 'var(--color-warning)' : 'var(--color-danger)',
