              ...
              <div className="card" key={i} style={{ marginBottom: '1rem' }}>
                <div className="card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div style={{
                    ...
                    background: cm.averagePercent >= 60 ? 'var(--color-success)' :
                      cm.averagePercent >= 40 ? 'var(--color-warning)' :
                        'var(--color-danger)',
                  }}>
                    {cm.averagePercent}%
                  </div>
                    ...
                    <div className="card-body">
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.75rem' }}>
                        ...
                        <div style={{
                          ...
                          background: cs.percentage >= 75 ? 'var(--color-success)' :
                            cs.percentage >= 60 ? 'var(--color-warning)' :
                              'var(--color-danger)',
                        }}>
                          {cs.percentage}%
                        </div>
